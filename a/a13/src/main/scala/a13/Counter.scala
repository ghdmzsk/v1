...
case class Number1S(tail2: Number2, tail3: Number3) extends Number1 {
  override def method1(num2: Number2,num3: Number3): Number1 = Number2S(num2.method2(tail3), tail1.method1(num2))
}
...
case class Number2S(tail1: Number1, tail2: Number2) extends Number2 {
  override def method2(num3: Number3): Number2 = Number1S(num3.method3(tail1), tail2.method2(num3))
}
...
case class Number3S(tail1: Number2, tail3: Number3) extends Number3 {
  override def method3(num2: Number2): Number3 = Number3S(num1.method1(tail1), tail3.method3(num1))
}
case class Number3T(tail3: () => Number3) extends Number3 {
  override def method3(num2: Number2): Number3 = tail3().method3(num1)
}
