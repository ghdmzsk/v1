...
object Runner {
  ...
  def genNumber1(n: Int, deep: Int, zero1: => Number1, zero2: => Number2, zero3: => Number3): Number1 = {
    if (deep > 0)
      Number1S(genNumber2(n - 1, deep - 1, zero1, zero2, zero3), genNumber3(n - 1, deep - 1, zero1, zero2, zero3))
    else
      Number1T(() => zero1)
  }
  def genNumber2(n: Int, deep: Int, zero1: => Number1, zero2: => Number2, zero3: => Number3): Number2 = {
    if (n > 0)
      Number2S(genNumber1(n - 1, deep, zero1, zero2, zero3), genNumber2(n - 1, deep - 1, zero1, zero2, zero3))
    else
      Number2T(() => zero2)
  }
  def genNumber3(n: Int, deep: Int, zero1: => Number1, zero2: => Number2, zero3: => Number3): Number3 = {
    if (n > 0)
      Number3S(genNumber1(n - 1, deep, zero1, zero2, zero3), genNumber3(n - 1, deep - 1, zero1, zero2, zero3))
    else
      Number3T(() => zero3)
  }
  ...
  def genNumber1_2(n: Int, deep: Int): Number1 = {
    if (deep > 0)
      Number1S(genNumber2_2(randomGen, deep - 1), genNumber3_2(n - 1, deep - 1))
    else
      Number1U
  }
  ...
  def genNumber3_2(n: Int, deep: Int): Number3 = {
    if (n > 0)
      Number3S(genNumber1_2(n - 1, deep), genNumber3_2(n - 1, deep - 1))
    else
      Number3U
  }
  ...
  def main(arr: Array[String]): Unit = {
    ...
    val num2_1: Number3 = genNumber3_2(10, 3)
    ...
    println(countNumber2(num2.method2(num2_1)))
    ...
    val c1 = countNumber2(num2.method2(num2_1)).num1 / (countNumber2(num2.method2(num2_1)).num2 - countNumber2(num2.method2(num2_1)).num3)
    println("s num 1 1", c1)
    val c2 = countNumber2(num2.method2(num2_1)).num2 / (countNumber2(num2.method2(num2_1)).num1 - countNumber2(num2.method2(num2_1)).num3)
    println("s num 1 2", c2)
    val c3 = countNumber2(num2.method2(num2_1)).num3 / (countNumber2(num2.method2(num2_1)).num1 - countNumber2(num2.method2(num2_1)).num2)
    println("s num 1 3", c3)

    val c4 = countNumber3(num2_1.method3(num2)).num1 / (countNumber3(num2_1.method3(num2)).num2 - countNumber3(num2_1.method3(num2)).num3)
    println("s num 1 1", c4)
    val c5 = countNumber3(num2_1.method3(num2)).num2 / (countNumber3(num2_1.method3(num2)).num1 - countNumber3(num2_1.method3(num2)).num3)
    println("s num 1 2", c5)
    val c6 = countNumber3(num2_1.method3(num2)).num3 / (countNumber3(num2_1.method3(num2)).num1 - countNumber3(num2_1.method3(num2)).num2)
