...
object Runner {
  ...
  object GenNumber1 {
    def gen1(n1: Int, n2: Int, deep: Int, tail1: => Number1_1, tail2: => Number1_2): Number1_1 = {
      if (deep > 0 && n1 > 0) {
        ...
        Number1_1S(gen1(n1 - left1 - 1 + m2, n2 - left2 + m2, deep - 1, tail1, tail2), gen2(left1 + m2, left2 + m2, deep - 1, tail1, tail2))
      } else {
        if (n1 > 0)
          Number1_1S(gen1(n1 - 1, n2, deep, tail1, tail2), tail2)
        else if (n2 > 0)
          Number1_1S(tail1, Number1_2S(gen2(n1, n2, deep, tail1, tail2), tail1))
        else
          tail1
      }
    }
    ...
    def gen2(n1: Int, n2: Int, deep: Int, tail1: => Number1_1, tail2: => Number1_2): Number1_2 = {
      if (deep > 0 && n2 > 0) {
        ...
        Number1_2S(gen2(n1 - left1 + m2, n2 - left2 - 1 + m2, deep - 1, tail1, tail2), gen1(left1 + m2, left2 + m2, deep - 1, tail1, tail2))
      } else {
        if (n2 > 0)
          Number1_2S(gen2(n1, n2 - 1, deep, tail1, tail2), tail1)
        else if (n1 > 0)
          Number1_2S(tail2, Number1_1S(gen1(n1, n2, deep, tail1, tail2), tail2))
        else
          tail2
      }
    }
  ...
  def main(arr: Array[String]): Unit = {
    for {
      ...
      lazy val num1_1Zero: Number1_1 = Number1_1T(() => num1_1Zero, () => num1_2Zero)
      lazy val num1_2Zero: Number1_2 = Number1_2T(() => num1_2Zero, () => num1_1Zero)
      ...
      val num1_2: Number1_2 =
        if (i1 > 0) GenNumber1.gen2(m1 + i1, m1, i5, num1_1Zero, num1_2Zero) else GenNumber1.gen2(m1, m1 - i1, i5, num1_1Zero, num1_2Zero)

      val num2_1: Number2_1 =
        if (i2 > 0) GenNumber2.gen1(m1 + i2, m1, i5, num2_1Zero, num2_2Zero) else GenNumber2.gen1(m1, m1 - i2, i5, num2_1Zero, num2_2Zero)
      val num2_2: Number2_2 =
        if (i2 > 0) GenNumber2.gen2(m1 + i2, m1, i5, num2_1Zero, num2_2Zero) else GenNumber2.gen2(m1, m1 - i2, i5, num2_1Zero, num2_2Zero)
