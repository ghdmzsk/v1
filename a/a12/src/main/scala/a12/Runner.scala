...
object Runner {
  ...
  def printlnNumber2(instance: ru.TypeTag[_], num2: Number2): Unit = num2 match {
    case Number2S(tail, head @ Number1S(_, _, instance2)) =>
      println(instance, instance2, instance2.tpe <:< instance.tpe)
  ...
  def printlnNumber3(instance: ru.TypeTag[_], num3: Number3): Unit = num3 match {
    case Number3S(tail, head @ Number1S(_, _, instance2)) =>
      println(instance, instance2, instance.tpe <:< instance2.tpe)
...
//(TypeTag[Any],TypeTag[a12.N3],true)
//(TypeTag[a12.N3],TypeTag[a12.N7],true)
//(TypeTag[a12.N7],TypeTag[a12.N5],true)
//(TypeTag[a12.N5],TypeTag[a12.N2],true)
//(TypeTag[a12.N7],TypeTag[a12.N4],true)
//(TypeTag[a12.N4],TypeTag[a12.N1],true)
//(TypeTag[a12.N4],TypeTag[a12.N3],true)
//(TypeTag[a12.N7],TypeTag[a12.N2],true)
//(TypeTag[a12.N7],TypeTag[a12.N1],true)
//(TypeTag[a12.N7],TypeTag[a12.N3],true)
//(TypeTag[a12.N3],TypeTag[a12.N4],true)
//(TypeTag[a12.N4],TypeTag[a12.N7],true)
//(TypeTag[a12.N7],TypeTag[a12.N5],true)
//(TypeTag[a12.N5],TypeTag[a12.N2],true)
//(TypeTag[a12.N7],TypeTag[a12.N4],true)
//(TypeTag[a12.N4],TypeTag[a12.N1],true)
...
//(TypeTag[a12.N7],TypeTag[a12.N1],true)
//(TypeTag[a12.N7],TypeTag[a12.N3],true)
//(TypeTag[a12.N4],TypeTag[a12.N6],true)
//(TypeTag[a12.N6],TypeTag[a12.N1],true)
//(TypeTag[a12.N6],TypeTag[a12.N4],true)
//(TypeTag[a12.N4],TypeTag[a12.N1],true)
//(TypeTag[a12.N4],TypeTag[a12.N3],true)
//(TypeTag[a12.N4],TypeTag[a12.N1],true)
//(TypeTag[a12.N4],TypeTag[a12.N3],true)
//(TypeTag[Any],TypeTag[a12.N2],true)
//(TypeTag[a12.N2],TypeTag[a12.N7],true)
//(TypeTag[a12.N7],TypeTag[a12.N5],true)
//(TypeTag[a12.N5],TypeTag[a12.N2],true)
//(TypeTag[a12.N7],TypeTag[a12.N4],true)
//(TypeTag[a12.N4],TypeTag[a12.N1],true)
...
//(TypeTag[a12.N7],TypeTag[a12.N1],true)
//(TypeTag[a12.N7],TypeTag[a12.N3],true)
//(TypeTag[a12.N2],TypeTag[a12.N5],true)
//(TypeTag[a12.N5],TypeTag[a12.N7],true)
//(TypeTag[a12.N7],TypeTag[a12.N5],true)
//(TypeTag[a12.N5],TypeTag[a12.N2],true)
//(TypeTag[a12.N7],TypeTag[a12.N4],true)
//(TypeTag[a12.N4],TypeTag[a12.N1],true)
...
//(TypeTag[a12.N7],TypeTag[a12.N3],true)
//(TypeTag[a12.N5],TypeTag[a12.N2],true)
//(TypeTag[Any],TypeTag[a12.N1],true)
//(TypeTag[a12.N1],TypeTag[a12.N7],true)
//(TypeTag[a12.N7],TypeTag[a12.N5],true)
//(TypeTag[a12.N5],TypeTag[a12.N2],true)
//(TypeTag[a12.N7],TypeTag[a12.N4],true)
//(TypeTag[a12.N4],TypeTag[a12.N1],true)
